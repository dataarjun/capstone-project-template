"""
Load Transactions Data into PostgreSQL Database

This script loads the transactions.csv file into PostgreSQL and provides functions
...
from app.db.postgres_session import get_postgres_url

class TransactionLoader:
    """Load and manage transaction data in PostgreSQL"""
    ...
    async def load_transactions_from_csv(self, csv_path: str, batch_size: int = 10000):
        ...
        try:
            for chunk in pd.read_csv(csv_path, chunksize=batch_size):
                ...
                chunk['created_timestamp'] = pd.to_datetime(chunk['TIMESTAMP'], unit='s', errors='coerce')
                chunk['created_timestamp'] = chunk['created_timestamp'].fillna(datetime.now())
...
class TransactionRetriever:
    """Retrieve transaction data for AML agents"""
...
async def main():
    ...
    print("🚀 Loading Transactions into PostgreSQL Database")
    print("=" * 60)
