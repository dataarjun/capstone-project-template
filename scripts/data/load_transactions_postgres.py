...
This script loads the transactions.csv file into PostgreSQL using the existing
database connection from the project.
"""
...
class PostgreSQLTransactionLoader:
...
class PostgreSQLTransactionRetriever:
...
async def main():
    ...
    # Initialize loader
    loader = PostgreSQLTransactionLoader()
    ...
    try:
        ...
        retriever = PostgreSQLTransactionRetriever()
